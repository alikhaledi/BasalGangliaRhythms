...
close all
rootan = [R.path.rootn 'data\ConnectionSweep'];
...
for CON = 1:2
    ...
    a = plotSweepSpectra(R.frqz,feat,feat{1},cmap1,{R.condname{[2 1 3]}}, [1 15 30],2:4:31,[1,1,1],statecmap{CON},1)
    title('M2 power')
%         ylim([1e-15 5e-14])
%         set(gca, 'YScale', 'log'); %, 'XScale', 'log')
    ...
    plotSweepSpectra(R.frqz,feat,feat{1},cmap1,{R.condname{[2 1 3]}}, [1 15 30],2:4:31,[4,4,1],statecmap{CON},1)
    title('STN power')
%         ylim([1e-16 1e-12])
%         set(gca, 'YScale', 'log'); %, 'XScale', 'log')
    ...
    plotSweepSpectra(R.frqz,feat,feat{1},cmap1,{R.condname{[2 1 3]}}, [1 15 30],2:4:31,[4,1,4],statecmap{CON},5)
