...
R.IntP.phaseStim.stimAmp = 1/4; %WAS 1/3; % times the variance of the normal input; % Might need higher for STN stim
R.IntP.phaseStim.stimPeriod = 0.5;  %WAS 0.5 % stimulation period
R.IntP.phaseStim.stimGap = 0.5; % break between stimulation

R.IntP.phaseStim.filtflag = 0;
R.IntP.phaseStim.epsthresh = 75;  % WAS 75
